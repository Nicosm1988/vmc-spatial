...
Fecha de corte inicial: 2026-08-04. Última actualización documental: Fase 2, 2026-08-04.
...
| F-017 | Vegetación, paños del jardín, bloques y columnas repetidas del exterior usan instancing y geometrías compartidas.                           | `src/scene/exterior/TowerExterior.tsx`, `src/scene/exterior/UrbanContext.tsx`               | Técnico; requiere benchmark para cuantificar beneficio            |
...
La investigación pública y la implementación procedural de Fase 2 **no cierran ni rebajan** `A-004`, `A-005` o `A-008`: volumetría, relación urbana, materiales, colores y fachada continúan siendo aproximaciones **DEMO / NO VERIFICADAS**.
...
| D-003 | Mantener `vmc-spatial/6` como contrato importable vigente durante Fases 1 y 2.                                       | Compatibilidad con presets/export actuales.                                                 | Se agregue el objeto versionado completo.                                               |
...
| D-012 | Usar LOD e instancing para repetición exterior, y diagnóstico sólo bajo opt-in.                                      | Controla costo de render y evita instrumentación permanente.                                | Un benchmark reproducible justifique modificar umbrales o estrategia.                   |
