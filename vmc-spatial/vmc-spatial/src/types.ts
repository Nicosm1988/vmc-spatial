...
export interface Zone {
  ...
  rot?: number            // radianes; rotación de la isla para seguir la fachada
...
export interface VmcDocument {
  ...
  plate: Point[]          // contorno REAL trazado del plano (mm)
  core: Point[]           // polígono del núcleo diamante (mm)
  columns: Point[]        // pilares del pasillo del frente (mm)
