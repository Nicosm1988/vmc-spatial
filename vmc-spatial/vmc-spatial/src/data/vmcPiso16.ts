...
export const VMC_PISO_16: VmcDocument = {
 ...
 zonas:[
  {id:'core',nombre:'Núcleo · Diamante',kind:'nucleo',cx:33000,cy:20000,color:'#0a1636',puestos:0,ocupacion:100,datalizacion:95,nota:'Núcleo.'},
  ...
  {id:'com-e1',nombre:'Comedor e1',kind:'comedor',cx:57038,cy:17969,w:3600,h:1600,rot:0.3491,color:'#8a5a2b',puestos:0,ocupacion:45,datalizacion:20,nota:'Mesa larga.'},
  {id:'com-e2',nombre:'Comedor e2',kind:'comedor',cx:58113,cy:22837,w:3600,h:1600,rot:-0.3491,color:'#8a5a2b',puestos:0,ocupacion:45,datalizacion:20,nota:'Mesa larga.'},
  {id:'com-w1',nombre:'Comedor w1',kind:'comedor',cx:6783,cy:18993,w:3600,h:1600,rot:0.0,color:'#8a5a2b',puestos:0,ocupacion:45,datalizacion:20,nota:'Mesa larga.'},
 ],
 videoWalls:[
