// ============================================================================
// PRESET · VMC Piso 16 — layout confirmado.
// Núcleo = DIAMANTE ASIMÉTRICO de 4 lados: vértices O/N/E/S. Los lados de ATRÁS
// (Oeste/fondo) son MÁS CORTOS que los del FRENTE (Este). Video walls en las
// 4 CARAS del diamante (incluida la del fondo). Islas BENCH (enfrentadas).
// ============================================================================
...
// Diamante 4 vértices: Oeste(atrás, corto) · Norte · Este(frente, largo) · Sur.
const CORE = [
...
export const VMC_PISO_16: VmcDocument = {
  ...
  zonas: [
    { id: 'core', nombre: 'Núcleo · Diamante (4 pantallas)', kind: 'nucleo', cx: 32500, cy: 20000, color: C.core, puestos: 0, ocupacion: 100, datalizacion: 95, nota: 'Diamante asimétrico: lados de atrás (O) cortos, de adelante (E) largos. Video walls en las 4 caras.' },

    // NORTE IZQUIERDO: 2 de3, larga5(paralela), 1 de3
    ...
    { id: 'sala-circ-nw', nombre: 'Sala circular (NO)', kind: 'circular', cx: 10295, cy: 16674, r: 1650, color: C.circ2, puestos: 0, ocupacion: 45, datalizacion: 20, nota: 'Sala de reunión circular.' },
  ...
  // 4 VIDEO WALLS en las 4 caras del diamante (incluye la del FONDO / Oeste).
  videoWalls: [
    { id: 'vw-no', nombre: 'Video Wall Atrás-Norte (O)', x1: 24980, y1: 19544, x2: 30020, y2: 14756, pantallas: 15 },
    { id: 'vw-ne', nombre: 'Video Wall Frente-Norte (E)', x1: 31460, y1: 14756, x2: 41540, y2: 19544, pantallas: 24 },
    { id: 'vw-se', nombre: 'Video Wall Frente-Sur (E)', x1: 41540, y1: 20456, x2: 31460, y2: 25244, pantallas: 24 },
    { id: 'vw-so', nombre: 'Video Wall Atrás-Sur (O)', x1: 30020, y1: 25244, x2: 24980, y2: 20456, pantallas: 15 },
  ],
  orientacion: [
