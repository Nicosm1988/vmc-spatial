// ============================================================================
// Panel Estructura: lista de zonas del piso, seleccionable.
// ============================================================================
  ...
  return (
    <div>
      ...
      <div className="zlist">
        {doc.zonas.map((z) => (
          ...
          >
            ...
            <span>{z.nombre}</span>
            <span className="meta">
              {z.puestos > 0 ? `${z.puestos} p.` : tipo(z.kind)}
            </span>
          </div>
        ))}
      </div>
      ...
      <div className="hint">
        ...
        <div>📐 Placa: <b>{(doc.ancho / 1000).toFixed(0)} × {(doc.alto / 1000).toFixed(0)} m</b></div>
      </div>
    </div>
  )
}
