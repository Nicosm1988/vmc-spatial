    ...
    <div>
      ...
      <div className="palette">
        ...
        <button className="pitem" onClick={onAddWall}>
          <span className="pico">📺</span><span>Pared de monitores</span>
        </button>
      </div>
      <div className="hint" style={{ marginTop: 8 }}>Aparece al centro; arrastralo a su lugar y ajustalo en el Inspector.</div>
    </div>
  )
}
